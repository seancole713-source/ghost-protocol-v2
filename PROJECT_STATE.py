...
LAST UPDATED: 2026-09-01 - PR #168: fixed tier-display contradiction + shadow-resolver alphabetical
starvation (both live-confirmed, both fixed with regression tests); investigated ghost_stats_v32
off-by-one and APGE 100% EXPIRED and confirmed both are NOT bugs (root-caused live, locked in with
tests, no statistical/gate logic touched); this ledger's session_summary was stale since 2026-08-07
despite 77 commits landing through 2026-08-31 (Squeeze Hunter subsystem, agent research workflow +
Codex worker, calibration-lifecycle governance, shadow-lane checklist calibration) — see the two
newest session_summary entries for the full gap summary and today's bug-fix detail.
"""
