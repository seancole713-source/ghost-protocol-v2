...
def _system_prompt() -> str:
    return (
        ...
        "If trade_action is RESEARCH ONLY (CORE_ENGINE_MODE=research), a core v3 pick is a research "
        "call, not a trade: never size it, and call its confidence an uncalibrated model probability.\n"
