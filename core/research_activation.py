...
def _activate_impl(cur, symbol, direction, artifact_sha, registration_id, review_id) -> Dict[str, Any]:
    ...
    meta = {"tier": "proven", "direction": direction, "model_sha256": expected_sha,
            ...
            "calibrated": gate_proof.get("calibrated"),
            "calibration_status": gate_proof.get("calibration_status"),
            "calibration_schema": gate_proof.get("calibration_schema"),
            "calibration_method": gate_proof.get("calibration_method"),
            "calibration_winner": gate_proof.get("calibration_winner"),
            "calibration_n": gate_proof.get("calibration_n"),
            "calibration_fit_n": gate_proof.get("calibration_fit_n"),
            "calibration_purge_n": gate_proof.get("calibration_purge_n"),
            "calibration_selection_n": gate_proof.get("calibration_selection_n"),
            "calibration_refit_n": gate_proof.get("calibration_refit_n"),
            "calibration_candidates": gate_proof.get("calibration_candidates") or [],
            "calibration_selection_metrics": gate_proof.get("calibration_selection_metrics"),
            "calibration_raw_selection_metrics": gate_proof.get("calibration_raw_selection_metrics"),
            "calibration_climatology_selection_metrics": gate_proof.get("calibration_climatology_selection_metrics"),
            "calibration_paired_raw_brier_improvement": gate_proof.get("calibration_paired_raw_brier_improvement"),
            "calibration_climatology_brier_improvement": gate_proof.get("calibration_climatology_brier_improvement"),
            "gate_brier": gate_proof.get("gate_brier"),
            "gate_n": gate_proof.get("gate_n"),
            "conformal_ok": bool((gate_proof.get("conformal") or {}).get("ok")),
            "conformal_q_hat": (gate_proof.get("conformal") or {}).get("q_hat"),
            "conformal_alpha": (gate_proof.get("conformal") or {}).get("alpha"),
            "conformal_samples": (gate_proof.get("conformal") or {}).get("samples"),
            "conformal_brier_raw": (gate_proof.get("conformal") or {}).get("brier_raw"),
            "conformal_brier_calibrated": (gate_proof.get("conformal") or {}).get("brier_calibrated"),
            "conformal_brier_improvement": (gate_proof.get("conformal") or {}).get("brier_improvement"),
