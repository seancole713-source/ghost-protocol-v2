...
| **Last prod-verified** | **2026-06-29** — PR #96 deployed (`4ea2e24`, `_pr_version 96`); 529 tests passing; model registry + feature attribution memory live (`/models`, `/feature-profile`, auth-gated `/features/score`) |
