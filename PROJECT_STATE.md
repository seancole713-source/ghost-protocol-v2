...
| **Last prod-verified** | **2026-06-29** — PR #98 deployed (`3cc0987`, `_pr_version 97`); 536 tests passing; Shadow Model Runner live (`/shadow`, `/shadow/models`, auth-gated `/shadow/run` + `/shadow/resolve`) |
