...
def test_candidate_preserves_production_precision_and_gate_metrics(monkeypatch):
    ...
    assert candidate["holdout"] == {
        ...
        "calibration_winner": None,
        "calibration_n": None,
        "calibration_fit_n": None,
        "calibration_purge_n": None,
        "calibration_selection_n": None,
        "calibration_refit_n": None,
        "calibration_candidates": [],
        "calibration_selection_metrics": None,
        "calibration_raw_selection_metrics": None,
        "calibration_climatology_selection_metrics": None,
        "calibration_paired_raw_brier_improvement": None,
        "calibration_climatology_brier_improvement": None,
        "conformal": {},
        "feature_inversions": ["macd"],
    }
